...
ESLINT_SETTINGS=".eslintrc.json"
GITHUB_DESKTOP_INSTALLER="GitHubDesktop.zip"
GIT_PROMPT=".git-prompt.sh"
GIT_COMPLETION=".git-completion.sh"
IBM_PLEX_MONO_INSTALLER="IBM_Plex_Mono.zip"
IBM_PLEX_MONO_FOLDER="IBM_Plex_Mono"
SASS_LINT_SETTINGS=".sass-lint.yml"
SPECTACLE_INSTALLER="Spectacle+1.2.zip"
SPECTACLE_SHORTCUTS_FILE="Shortcuts.json"
STYLELINT_SETTINGS=".stylelintrc.json"
TERMINAL_THEME="TomorrowNight.terminal"
TYPORA_DISK_IMAGE="Typora.dmg"
UBUNTU_MONO_INSTALLER="Ubuntu_Mono.zip"
UBUNTU_MONO_FOLDER="Ubuntu_Mono"
